...
# save results
saveRDS(df_raw_np, "df_raw_np.rds")
```
...
# save results
saveRDS(df_raw_par, "df_raw_par.rds")
```
...
# save results
saveRDS(df_reflected, "df_reflected.rds")
```
...
# save results
saveRDS(df_bootstrap_t, "df_bootstrap_t.rds")
```
...
# # results folder
# folder_rds <- here("method_3-4_CLH", "all_results")
# 
# # load results from each method
# df_exact <- readRDS(here(folder_rds, "df_exact.rds"))
# df_delta <- readRDS(here(folder_rds, "all_results", "df_delta.rds"))
# df_raw_np <- readRDS(here(folder_rds, "all_results", "df_raw_np.rds"))
# df_raw_par <- readRDS(here(folder_rds, "all_results", "df_raw_par.rds"))
# df_reflected <- readRDS(here(folder_rds, "all_results", "df_reflected.rds"))
# df_bootstrap_t <- readRDS(here(folder_rds, "all_results", "df_bootstrap_t.rds"))
